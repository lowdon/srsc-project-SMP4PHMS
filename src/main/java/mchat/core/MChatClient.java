package mchat.core;// MChatClient.java
// Main Multicast Chat-Message tool
// 

import mchat.sockets.SecureMulticastChat;
import mchat.sockets.MulticastChatEventListener;
...
public class MChatClient extends JFrame implements MulticastChatEventListener
{
	...
	protected DefaultListModel<String> users;

	// Constructor for the chat multicast  
	public MChatClient() {
		super("SecureMulticastChat");
